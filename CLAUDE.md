# CLAUDE.md — Springhelm Garage Door Repairs, clone-and-adapt build chain
...
BUSINESS           = Springhelm Garage Door Repairs
TAGLINE            = One number, one technician, no handoffs.
PHONE              = (919) 555-0158
ADDRESS            = 2619 Halloway Trace, Apex, NC 27502
MAP_COORDS         = 35.7327,-78.8503
HOURS              = 7 days, 7:00 AM – 7:00 PM
SERVICE_AREA       = Serving Apex and the west Raleigh metro.
...
- **Proposition category** (Prompt 3, item 3): **a real person answers the phone.**
